...
;  jsr     ClearScreen
  ...
  move.w  CUSTOM+JOYPAD0,d0             ; Read joypad status
...
; Draw a 16x16 square at d2,d3 in color d4
DrawSquare:
  move.l  PhysicalScreen,a0
  mulu.w  #SCREEN_DEPTH/8,d2
  mulu.w  #SCREEN_WIDTH*(SCREEN_DEPTH/8),d3
  add.l   d2,d3
  adda.l  d3,a0
  move.w  #15,d7
.NextLine:
...
.NextPixel:
  move.w  d4,(a1)+
  dbf     d6,.NextPixel
  adda.l  #SCREEN_WIDTH*(SCREEN_DEPTH/8),a0
  dbf     d7,.NextLine
  rts

; Draw a 8x8 char at d2,d3 value in a4
DrawChar:
  movem.l d0-a6,-(sp)
  move.l  PhysicalScreen,a0
  mulu.w  #SCREEN_DEPTH/8,d2
...
ZeroChar:
  ...
  dc.w    $FFFF,$0000,$FFFF,$0000,$0000,$0000,$FFFF,$0000
  dc.w    $FFFF,$0000,$0000,$FFFF,$0000,$0000,$FFFF,$0000
  dc.w    $FFFF,$0000,$0000,$0000,$FFFF,$0000,$FFFF,$0000
  dc.w    $FFFF,$0000,$0000,$0000,$0000,$FFFF,$FFFF,$0000
  dc.w    $0000,$FFFF,$FFFF,$FFFF,$FFFF,$FFFF,$0000,$0000
...
OneChar:  
  ...
  dc.w    $0000,$FFFF,$FFFF,$FFFF,$FFFF,$0000,$0000,$0000
  dc.w    $0000,$FFFF,$FFFF,$FFFF,$FFFF,$0000,$0000,$0000
  dc.w    $0000,$0000,$FFFF,$FFFF,$FFFF,$0000,$0000,$0000
  dc.w    $0000,$0000,$FFFF,$FFFF,$FFFF,$0000,$0000,$0000
  dc.w    $0000,$0000,$FFFF,$FFFF,$FFFF,$0000,$0000,$0000
