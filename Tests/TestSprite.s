...
; DMA activation
DMA_SET             = DMA_ON|DMA_COPPER|DMA_BITPLANE|DMA_SPRITE
DMA_SET2            = DMA_STOP
...
.SetupSpriteControl:
  move.l  #SCREEN_STARTX+50,d0					; Sprite start HSTART
  move.l  #SCREEN_STARTY+50,d1          ; Sprite start VSTART
  move.l  #SCREEN_STARTY+50+16,d2       ; Srpite stop VSTOP
...
.SetupNewSprite:
  lea     CLSpriteAdr,a0                ; Copperlist sprites
  move.l  #NewSprite,d0                 ; New SAGA sprite
  move.w  d0,6(a0)                      ; Sprite address low
  swap    d0
  move.w  d0,2(a0)                      ; Sprite address high
;  move.l  d0,2(a0)
...
SpritePal:
  dc.l    $000000,$110000,$220000,$330000,$440000,$550000,$660000,$770000
  dc.l    $880000,$990000,$AA0000,$BB0000,$CC0000,$DD0000,$EE0000,$FF0000
...
NewSprite:
  dc.w    $0000                         ; Sprite position
  dc.w    $0000,$0000                   ; Empty filler
  dc.w    $0001                         ; New SAGA control
  dc.w    $0000                         ; Sprite control
  dc.w    $0000                         ; Empty filler
  dc.l    NewSpriteData                 ; Sprite data

  CNOP    0,64
NewSpriteData:
  REPT    16
  dc.l    $55555555,$33333333,$0f0f0f0f,$ffffffff
  ENDR
...
CLScreenDef:
  ...
  CMOVE   $0000,BPLCON1
  CMOVE   $003F,BPLCON2                 ; Sprites prio PF1 & PF2
  CMOVE   $0C00,BPLCON3
  CMOVE   $0011,BPLCON4
