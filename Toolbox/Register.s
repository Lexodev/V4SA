...
; Register.s
;
; Hardware registers constants OCS, ECS, AGA and SAGA
;
...
;*******************************************************************************
; Custom chips registers (SAGA)
;*******************************************************************************

CUSTOMR       = $DFE000       ; SAGA base register for read only

BPLHMOD       = $1E6          ; Chunky plane modulo
BPLHPT        = $1EC          ; Chunky plane pointer (32bit PTR)
BPLHPTH       = $1EC          ; Chunky plane pointer (hi 16 bits)
BPLHPTL       = $1EE          ; Chunky plane pointer (lo 16 bits)
GFXMODE       = $1F4          ; Set Resolution and Pixformat
DMACON2R      = $202          ; Dma control 2 (and blitter status) read
MWHEEL        = $212          ; Mouse Wheel read register
INTENA2R      = $21c          ; Interrupt 2 enable bits read
INTREQ2R      = $21E          ; Interrupt 2 request bits read
JOY0BTNS      = $220          ; 16bit USB Joy Buttons (0)=active
JOY1BTNS      = $222          ; 16bit USB Joy Buttons (0)=active
JOY2BTNS      = $224          ; 16bit USB Joy Buttons (0)=active
JOY3BTNS      = $226          ; 16bit USB Joy Buttons (0)=active
CLXDAT0       = $230          ; Sprite0 Detailed Collision
CLXDAT1       = $232          ; Sprite1 Detailed Collision
CLXDAT2       = $234          ; Sprite2 Detailed Collision
CLXDAT3       = $236          ; Sprite3 Detailed Collision
CLXDAT4       = $238          ; Sprite4 Detailed Collision
CLXDAT5       = $23A          ; Sprite5 Detailed Collision
CLXDAT6       = $23C          ; Sprite6 Detailed Collision
CLXDAT7       = $23E          ; Sprite7 Detailed Collision
...
TEXSTRT       = $25E          ; Line len & start maggie
                              ;  Bit15=0 = Start new job, Bit15=1 = Continue previous job, Bit10..0 = length in pixel
TEXMIP        = $260          ; MIP texture size
                              ;  Bit(3..0) ($A=1024/9=512/8=256/7=128/6=64/5=32) Bit4=1 = AutoMipMapMode with Bit3-0 define max mip
TEXMODE       = $262          ; Render mode
                              ;  Bit0=use Bilinear, Bit1=use Zbuffer, Bit2=select 16bit output, Bit3=inhibit Zbuffer write,
                              ;  Bit4=select 24bit output, Bit5=Quadratic-mode, Bit7-6=Blending mode ("00"=COPY/"01"=ADD/"10"=MUL) 
TEXDMOD       = $266          ; Dest modulo (texel size)
TEXDDU        = $268          ; 24bit ddUUuuuu (quadratic)
TEXDDV        = $26C          ; 24bit ddVVvvvv (quadratic)
TEXU          = $270          ; U value in fixed 8:16 (UUuuuu)
TEXV          = $274          ; V value in fixed 8:16 (VVvvvv)
TEXDU         = $278          ; dU value in fixed 8:16 (dUUuuuu)
TEXDV         = $27C          ; dV value in fixed 8:16 (dVVvvvv)
TEXLIGHT      = $280          ; Ligth value in fixed 8:8
TEXDLIGHT     = $282          ; Delta light value in fixed 8:8
TEXLCOLOR     = $284          ; Light color in ARGB
TEXZ          = $288          ; Z value in fixed 16:16 (ZZZZzzzz)
TEXDZ         = $28C          ; dZ value in fixed 16:16 (dZZZZzzzz)

DMACON2       = $296          ; DMA control 2 write (clear or set)
INTENA2       = $29A          ; Interrupt 2 enable bits (clear or set bits)
INTREQ2       = $29C          ; Interrupt 2 request bits (clear or set bits)
PLANARCOL     = $380          ; 32bit Planar COLOR Port register
PLANARCOLH    = $380          ; 32bit Planar COLOR Port register
PLANARCOLL    = $382          ; 256 Color Register, Format [ID,RR,GG,BB] 
SPRITECOL     = $384          ; 32bit Sprite COLOR Port register
SPRITECOLH    = $384          ; 32bit Sprite COLOR Port register
SPRITECOLL    = $386          ; 256 Color Register, Format [ID,RR,GG,BB] 
CHUNKYCOL     = $388          ; 32bit Chunky COLOR Port register
CHUNKYCOLH    = $388          ; 32bit Chunky COLOR Port register
CHUNKYCOLL    = $38A          ; 256 Color Register, Format [ID,RR,GG,BB] 
PIPCOL        = $38C          ; 32bit PIP COLOR Port register
PIPCOLH       = $38C          ; 32bit PIP COLOR Port register
PIPCOLL       = $38E          ; 256 Color Register, Format [ID,RR,GG,BB] 
PIPXSTRT      = $3D0          ; X start
PIPYSTRT      = $3D2          ; Y start
PIPXSTOP      = $3D4          ; X stop
PIPYSTOP      = $3D6          ; Y stop
PIPPTR        = $3D8          ; 32 bit Ptr
PIPPTRH       = $3D8          ; 32 bit Ptr (high 16 bits)
PIPPTRL       = $3DA          ; 32 bit Ptr (low 16 bits)
PIPFORMAT     = $3DC          ; Colorformat (8bit/16bit/15bit/YUV)
PIPMODULO     = $3DE          ; Modulo
PIPCOLORKEY   = $3E0          ; ColorKey 1000,RRRR,GGGG,BBBB
PIPDMAROWLEN  = $3E2          ; PipDMARowLen
VAMPVERS      = $3FC          ; 8bit Card Version / 8bit clock multiplier

; Arne registers
VAUD0LC       = $400          ; Audio channel 0 location (32bit PTR)
VAUD0LCH      = $400          ;     '   '    (hi 16 bits)
VAUD0LCL      = $402          ;     '   '    (low 16 bits)
VAUD0LEN      = $404          ; Audio channel 0 length (32bit)
VAUD0LENH     = $404          ;     '   '    (hi 16 bits)
VAUD0LENL     = $406          ;     '   '    (low 16 bits)
VAUD0VOL      = $408          ; 2x8bit VOL (LEFT/RIGHT)
VAUD0CTRL     = $40A          ; 16bit Control (Bit2=Stereo Bit1=Oneshot Bit0=8bit/16bit)
VAUD0PER      = $40C          ; 16bit PERIOD
VAUD1LC       = $410          ; Audio channel 1 location (32bit PTR)
VAUD1LCH      = $410          ;     '   '    (hi 16 bits)
VAUD1LCL      = $412          ;     '   '    (low 16 bits)
VAUD1LEN      = $414          ; Audio channel 1 length (32bit)
VAUD1LENH     = $414          ;     '   '    (hi 16 bits)
VAUD1LENL     = $416          ;     '   '    (low 16 bits)
VAUD1VOL      = $418          ; 2x8bit VOL (LEFT/RIGHT)
VAUD1CTRL     = $41A          ; 16bit Control (Bit2=Stereo Bit1=Oneshot Bit0=8bit/16bit)
VAUD1PER      = $41C          ; 16bit PERIOD
VAUD2LC       = $420          ; Audio channel 2 location (32bit PTR)
VAUD2LCH      = $420          ;     '   '    (hi 16 bits)
VAUD2LCL      = $422          ;     '   '    (low 16 bits)
VAUD2LEN      = $424          ; Audio channel 2 length (32bit)
VAUD2LENH     = $424          ;     '   '    (hi 16 bits)
VAUD2LENL     = $426          ;     '   '    (low 16 bits)
VAUD2VOL      = $428          ; 2x8bit VOL (LEFT/RIGHT)
VAUD2CTRL     = $42A          ; 16bit Control (Bit2=Stereo Bit1=Oneshot Bit0=8bit/16bit)
VAUD2PER      = $42C          ; 16bit PERIOD
VAUD3LC       = $430          ; Audio channel 1 location (32bit PTR)
VAUD3LCH      = $430          ;     '   '    (hi 16 bits)
VAUD3LCL      = $432          ;     '   '    (low 16 bits)
VAUD3LEN      = $434          ; Audio channel 3 length (32bit)
VAUD3LENH     = $434          ;     '   '    (hi 16 bits)
VAUD3LENL     = $436          ;     '   '    (low 16 bits)
VAUD3VOL      = $438          ; 2x8bit VOL (LEFT/RIGHT)
VAUD3CTRL     = $43A          ; 16bit Control (Bit2=Stereo Bit1=Oneshot Bit0=8bit/16bit)
VAUD3PER      = $43C          ; 16bit PERIOD
VAUD4LC       = $440          ; Audio channel 4 location (32bit PTR)
VAUD4LCH      = $440          ;     '   '    (hi 16 bits)
VAUD4LCL      = $442          ;     '   '    (low 16 bits)
VAUD4LEN      = $444          ; Audio channel 4 length (32bit)
VAUD4LENH     = $444          ;     '   '    (hi 16 bits)
VAUD4LENL     = $446          ;     '   '    (low 16 bits)
VAUD4VOL      = $448          ; 2x8bit VOL (LEFT/RIGHT)
VAUD4CTRL     = $44A          ; 16bit Control (Bit2=Stereo Bit1=Oneshot Bit0=8bit/16bit)
VAUD4PER      = $44C          ; 16bit PERIOD
VAUD5LC       = $450          ; Audio channel 5 location (32bit PTR)
VAUD5LCH      = $450          ;     '   '    (hi 16 bits)
VAUD5LCL      = $452          ;     '   '    (low 16 bits)
VAUD5LEN      = $454          ; Audio channel 5 length (32bit)
VAUD5LENH     = $454          ;     '   '    (hi 16 bits)
VAUD5LENL     = $456          ;     '   '    (low 16 bits)
VAUD5VOL      = $458          ; 2x8bit VOL (LEFT/RIGHT)
VAUD5CTRL     = $45A          ; 16bit Control (Bit2=Stereo Bit1=Oneshot Bit0=8bit/16bit)
VAUD5PER      = $45C          ; 16bit PERIOD
VAUD6LC       = $460          ; Audio channel 6 location (32bit PTR)
VAUD6LCH      = $460          ;     '   '    (hi 16 bits)
VAUD6LCL      = $462          ;     '   '    (low 16 bits)
VAUD6LEN      = $464          ; Audio channel 6 length (32bit)
VAUD6LENH     = $464          ;     '   '    (hi 16 bits)
VAUD6LENL     = $466          ;     '   '    (low 16 bits)
VAUD6VOL      = $468          ; 2x8bit VOL (LEFT/RIGHT)
VAUD6CTRL     = $46A          ; 16bit Control (Bit2=Stereo Bit1=Oneshot Bit0=8bit/16bit)
VAUD6PER      = $46C          ; 16bit PERIOD
VAUD7LC       = $470          ; Audio channel 7 location (32bit PTR)
VAUD7LCH      = $470          ;     '   '    (hi 16 bits)
VAUD7LCL      = $472          ;     '   '    (low 16 bits)
VAUD7LEN      = $474          ; Audio channel 7 length (32bit)
VAUD7LENH     = $474          ;     '   '    (hi 16 bits)
VAUD7LENL     = $476          ;     '   '    (low 16 bits)
VAUD7VOL      = $478          ; 2x8bit VOL (LEFT/RIGHT)
VAUD7CTRL     = $47A          ; 16bit Control (Bit2=Stereo Bit1=Oneshot Bit0=8bit/16bit)
VAUD7PER      = $47C          ; 16bit PERIOD
